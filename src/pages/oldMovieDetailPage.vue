  ...
  <div class="min-h-screen app-bg text-[#eaf0ff]">
    <div class="movie-detail-page max-w-[1200px] mx-auto p-4">
      ...
      <div v-else class="grid gap-8 lg:grid-cols-3">
        <!-- Poster (left) -->
        <div
          class="col-span-1 poster-card rounded-xl overflow-hidden shadow-lg bg-gradient-to-b from-white/3 to-black/20"
        >
          <img
          ...
          <div class="p-3 text-sm text-[#98a1b3]">
            ...
            <div
              v-if="movie.tagline"
              class="mt-2 italic text-xs text-[#a6b0c6]"
            >
              "{{ movie.tagline }}"
            </div>
          </div>
        ...
        <div class="col-span-2 lg:col-span-2 grid gap-6">
          ...
          >
            ...
            <div class="flex items-start gap-4">
              ...
              <div class="rating-circle">
                <div class="rating-value">{{ imdbRatingDisplay }}</div>
                <div class="rating-label text-xs">IMDb</div>
              </div>
            </div>
          </div>
          ...
          <div class="grid md:grid-cols-3 gap-6">
            <div class="md:col-span-2">
              ...
              <div
                class="overview-panel p-4 rounded-lg bg-white/4 border border-white/6"
              >
            ...
            <!-- <div class="cast-panel">
              ...
              <div v-if="topCast.length === 0" class="text-sm text-[#98a1b3]">
                No cast available.
              </div>
              <ul class="space-y-3">
                <li
            ...
            <div class="mt-4 grid md:grid-cols-2 gap-6">
              <div>
                ...
                <div class="text-sm text-[#98a1b3] space-y-2">
                  ...
                  <div>
                    <strong class="text-white">Original language:</strong>
              ...
              <div>
                ...
                <ul class="text-sm text-[#98a1b3] space-y-2">
                  ...
                  <li>
                    <strong class="text-white">Revenue:</strong>
                    {{
        ...
        <div v-if="movie.vote_count && movie.vote_count > 0" class="mt-12">
          ...
          <div class="reviews-summary-panel">
            <div class="flex items-center gap-4 mb-4">
              ...
              <div>
                ...
                <div class="text-sm text-[#98a1b3]">
                  {{ movie.popularity?.toFixed(0) || "N/A" }} Popularity Score
                </div>
              </div>
            </div>
            ...
            <p class="text-sm text-[#d7dde8] leading-relaxed">
              Audiences appreciate <strong>{{ movie.title }}</strong> for its
              {{ getReviewTone() }}. With a rating of
              <strong>{{ movie.vote_average?.toFixed(1) }}/10</strong> from
              <strong>{{ formatVoteCount(movie.vote_count) }}</strong> viewers,
              the film has resonated with
              {{
        ...
        <div v-if="similarMovies.length > 0" class="mt-12 mb-8">
          ...
          <div class="similar-movies-grid">
            <div
              ...
              class="similar-movie-card group cursor-pointer"
            >
              ...
              <div class="p-3">
                <h3
                  class="font-semibold text-sm text-white line-clamp-1 group-hover:text-[#6b6bff] transition-colors"
                >
                  {{ similar.title }}
                </h3>
